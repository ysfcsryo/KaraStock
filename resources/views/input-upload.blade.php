...
<div class="hero-section">
    <div class="hero-content">
        <h1 class="display-4 fw-bold mb-3">
            <i class="bi bi-graph-up"></i> KaraStock
        </h1>
        <p class="lead mb-0">
            Gunakan AI dan Decision Tree untuk mendapatkan rekomendasi stok yang akurat dan berbasis data
        </p>
    </div>
</div>
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        <!-- How It Works -->
        <div class="card card-interactive shadow-sm mb-4">
            <div class="card-body p-4">
                <h5 class="fw-bold mb-3">
                    <i class="bi bi-gear" style="color: #6366f1;"></i> Cara Kerja Sistem
                </h5>
                <ol class="ps-3 small lh-lg">
                    <li class="mb-2">
                        <strong>Unggah data</strong> penjualan dalam format CSV
                    </li>
                    <li class="mb-2">
                        Sistem <strong>memberi label</strong> otomatis berdasarkan aturan awal
                    </li>
                    <li class="mb-2">
                        Algoritma <strong>Decision Tree dilatih</strong> dari data Anda
                    </li>
                    <li class="mb-0">
                        Dapatkan <strong>rekomendasi stok</strong> untuk setiap produk
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="card card-interactive shadow-sm">
            <div class="card-body p-4">
                <h5 class="fw-bold mb-3">
                    <i class="bi bi-lightbulb" style="color: #f59e0b;"></i> Format Data
                </h5>
                <p class="small text-muted mb-3">File CSV harus memiliki kolom:</p>
                <ul class="feature-list small">
                    <li><strong>Nama</strong> - nama produk</li>
                    <li><strong>Kategori</strong> - kategori produk</li>
                    <li><strong>Harga</strong> - harga produk</li>
                    <li><strong>Terjual</strong> - jumlah pcs terjual</li>
                    <li><strong>Lama Barang</strong> - umur barang dalam hari</li>
                </ul>
            </div>
        </div>
    </div>
